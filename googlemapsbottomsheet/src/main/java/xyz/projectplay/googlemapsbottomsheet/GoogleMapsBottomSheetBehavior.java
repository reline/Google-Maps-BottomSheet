...
/**
 * Created by nathan on 8/25/16.
 */
/**
 * An interaction behavior plugin for an extended child view of {@link android.support.design.widget.BottomSheetBehavior} to make
 * it work similar to the Google Maps bottom sheet.
 */
public class GoogleMapsBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {

    private static final String TAG = "gpsidv:BottomSheet";
    ...
    public GoogleMapsBottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        setAnchorHeight(
                a.getDimensionPixelSize(R.styleable.BottomSheetBehavior_Layout_behavior_anchorOffset, 0));
        a.recycle();
